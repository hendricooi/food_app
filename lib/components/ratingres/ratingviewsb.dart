...
class RatingViewSB extends StatefulWidget {
  const RatingViewSB({Key? key}) : super(key: key);

  @override
  _RatingViewSBState createState() => _RatingViewSBState();
}

class _RatingViewSBState extends State<RatingViewSB> {
  ...
  _buildThanksNote() {
    return Column(
      ...
      children: [
        Text(
          "Thank you for browsing Starbucks",
          style: TextStyle(
            fontSize: 24,
            color: Colors.red,
