...
class RatingView7 extends StatefulWidget {
  const RatingView7({Key? key}) : super(key: key);

  @override
  _RatingView7State createState() => _RatingView7State();
}

class _RatingView7State extends State<RatingView7> {
  ...
  _buildThanksNote() {
    return Column(
      ...
      children: [
        Text(
          "Thank you for browsing 7 Village",
          style: TextStyle(
            fontSize: 24,
            color: Colors.red,
