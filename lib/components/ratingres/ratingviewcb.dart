...
class RatingViewCB extends StatefulWidget {
  const RatingViewCB({Key? key}) : super(key: key);

  @override
  _RatingViewCBState createState() => _RatingViewCBState();
}

class _RatingViewCBState extends State<RatingViewCB> {
  ...
  _buildThanksNote() {
    return Column(
      ...
      children: [
        Text(
          "Thank you for browsing Coffee Bean",
          style: TextStyle(
            fontSize: 24,
            color: Colors.red,
