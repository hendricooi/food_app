...
class RatingViewbb extends StatefulWidget {
  const RatingViewbb({Key? key}) : super(key: key);

  @override
  _RatingViewbbState createState() => _RatingViewbbState();
}

class _RatingViewbbState extends State<RatingViewbb> {
  ...
  _buildThanksNote() {
    return Column(
      ...
      children: [
        Text(
          "Thank you for browsing Blackball",
          style: TextStyle(
            fontSize: 24,
            color: Colors.red,
