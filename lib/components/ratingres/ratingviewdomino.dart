...
class RatingViewDomino extends StatefulWidget {
  @override
  _RatingViewDominoState createState() => _RatingViewDominoState();
}

class _RatingViewDominoState extends State<RatingViewDomino> {
  ...
  _buildThanksNote() {
    return Column(
      ...
      children: [
        Text(
          "Thank you for browsing Domino's Pizza",
          style: TextStyle(
            fontSize: 24,
            color: Colors.red,
