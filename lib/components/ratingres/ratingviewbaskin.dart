...
class RatingViewbaskin extends StatefulWidget {
  const RatingViewbaskin({Key? key}) : super(key: key);

  @override
  _RatingViewbaskinState createState() => _RatingViewbaskinState();
}

class _RatingViewbaskinState extends State<RatingViewbaskin> {
  ...
  _buildThanksNote() {
    return Column(
      ...
      children: [
        Text(
          "Thank you for browsing Baskin Robbins",
          style: TextStyle(
            fontSize: 24,
            color: Colors.red,
