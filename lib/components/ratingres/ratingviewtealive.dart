...
class RatingViewtealive extends StatefulWidget {
  const RatingViewtealive({Key? key}) : super(key: key);

  @override
  _RatingViewtealiveState createState() => _RatingViewtealiveState();
}

class _RatingViewtealiveState extends State<RatingViewtealive> {
  ...
  _buildThanksNote() {
    return Column(
      ...
      children: [
        Text(
          "Thank you for browsing Tealive",
          style: TextStyle(
            fontSize: 24,
            color: Colors.red,
