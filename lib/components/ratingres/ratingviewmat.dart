...
class RatingViewmat extends StatefulWidget {
  const RatingViewmat({Key? key}) : super(key: key);

  @override
  _RatingViewmatState createState() => _RatingViewmatState();
}

class _RatingViewmatState extends State<RatingViewmat> {
  ...
  _buildThanksNote() {
    return Column(
      ...
      children: [
        Text(
          "Thank you for browsing Mat Toh Yau",
          style: TextStyle(
            fontSize: 24,
            color: Colors.red,
