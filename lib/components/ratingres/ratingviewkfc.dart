...
class RatingViewKFC extends StatefulWidget {
  const RatingViewKFC({Key? key}) : super(key: key);

  @override
  _RatingViewKFCState createState() => _RatingViewKFCState();
}

class _RatingViewKFCState extends State<RatingViewKFC> {
