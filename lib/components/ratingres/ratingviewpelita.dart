...
class RatingViewpelita extends StatefulWidget {
  const RatingViewpelita({Key? key}) : super(key: key);

  @override
  _RatingViewpelitaState createState() => _RatingViewpelitaState();
}

class _RatingViewpelitaState extends State<RatingViewpelita> {
